...
class IntegralController extends CCController {
	...
	public function actionCourse(int $user_id, int $periods_id) {
		return new CCResponse($this->integral->course($user_id, $periods_id, $this->getParamAsArray('class_id'), $this->getParamAsArray('course_id'), $this->getParamAsArray('business_type'), $this->getParamAsArray('dest_type')));
	}
	...
	public function actionCreate(int $user_id, int $periods_id, int $class_id, int $course_id, int $business_type, int $dest_type, int $dest_id, int $stars, string $remark = '', int $duplicates = 0, string $platform = '') {
		$ret = $this->integral->create($user_id, $periods_id, $class_id, $course_id, $business_type, $dest_type, $dest_id, $stars, $remark, $duplicates, $platform);
